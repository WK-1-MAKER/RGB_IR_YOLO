...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='runs/train/MSDA-FLIR-n-layer_n1-bt20-ep40/weights/last.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='FLIR.yaml', help='*.data path')
