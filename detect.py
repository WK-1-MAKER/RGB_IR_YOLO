...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default="/home/SENSETIME/wenkai/YOLOV8_IR_RGB/weights/transformer_LLVIP/weights/best.pt", help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default="test/rgb/010001.jpg", help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default="/home/SENSETIME/wenkai/YOLOV8_IR_RGB/test/ir/010001.jpg", help='source')  # file/folder, 0 for webcam
