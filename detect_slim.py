...
# 检测参数
parser.add_argument('--weights', default="weights/transformer_LLVIP/weights/best.pt", type=str, help='weights path')
parser.add_argument('--image_rgb', default="test/rgb", type=str,
                    help='image_rgb')
parser.add_argument('--image_ir', default="test/ir", type=str,
                    help='image_rgb')
