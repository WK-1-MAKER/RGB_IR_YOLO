...
if __name__ == '__main__':
    ...
    parser.add_argument('--source1', type=str, default='/home/wk/multispectral-object-detection-main/data/datasets/RGB_images/images', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='/home/wk/multispectral-object-detection-main/data/datasets/IR_images/images', help='source')  # file/folder, 0 for webcam
